...
struct conditionNode {
	int relop;
	struct exprNode* left_operand;
	struct exprNode* right_operand;
};
...
void type_var(struct declNode*);
void sym_var_list(struct var_decl_listNode*);
void sym_var_section(struct var_decl_sectionNode*);
void sym_var(struct var_declNode*);
void sym_type_list(struct type_decl_listNode*);
void sym_type_section(struct type_decl_sectionNode*);
void sym_type(struct type_declNode*);
void sym_id_list(struct id_listNode*, int);
int find_new_type(int);
void change_type(int,int);
int check_expression_prefix(struct exprNode*);
void check_while_statement(struct while_stmtNode*);
void check_assign_stmt(struct assign_stmtNode*);
void check_body(struct bodyNode*);
void check_stmt_list(struct stmt_listNode*); 
